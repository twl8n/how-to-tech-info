...
This document created/revised 2026-04-14 April 14, 2026
...
- Beeps when temp knobs are moved. Cannot be disabled, as far as I know.
- Cooling fans have a buzz
- LED indicates power level when on
- LED HE indicates when a burner may be hot from contact with a pan
- LED colors are kind of a dim, dark blue/navy 
...
Other units with touch countrols may require some current for the microcontroller that senses the touch panel.

There are two cooling fans. The fans are temperature sensing and each fan only runs when required. Sadly, the fans are buzzy sounding. The noise isn't too irritating when the drawers under the cooktop are closed. If I had paid the $2500 retail price I'd be pretty darned upset with the buzzing fans. Why aren't all cooling fans quiet? I had a whisper quiet 5 inch CPU cooler on my AMD Opteron in 2001, and now 25 year later Frigidaire can't make a quiet fan? Clearly, they aren't trying.
...
<a href="https://www.frigidaire.com/en/p/kitchen/cooktops/induction-cooktops/FPIC3077RF" target="_blank">Frigidaire FPIC3077R official page</a> ![link small external](image/link-external-small.png)
